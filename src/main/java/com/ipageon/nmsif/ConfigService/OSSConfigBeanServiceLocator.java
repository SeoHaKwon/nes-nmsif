...
public class OSSConfigBeanServiceLocator extends org.apache.axis.client.Service implements com.ipageon.nmsif.ConfigService.OSSConfigBeanService {
    ...
    private java.lang.String ConfigService_address = "http://localhost:8080/nex-relaynms-ktpots20ems/services/ConfigService";
    ...
    public com.ipageon.nmsif.ConfigService.OSSConfigBean getConfigService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.ipageon.nmsif.ConfigService.ConfigServiceSoapBindingStub _stub = new com.ipageon.nmsif.ConfigService.ConfigServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ipageon.nmsif.ConfigService.OSSConfigBean.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.ipageon.nmsif.ConfigService.ConfigServiceSoapBindingStub _stub = new com.ipageon.nmsif.ConfigService.ConfigServiceSoapBindingStub(new java.net.URL(ConfigService_address), this);
                _stub.setPortName(getConfigServiceWSDDServiceName());
                return _stub;
            }
        }
