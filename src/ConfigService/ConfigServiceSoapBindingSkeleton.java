...
public class ConfigServiceSoapBindingSkeleton implements ConfigService.OSSConfigBean, org.apache.axis.wsdl.Skeleton {
    private ConfigService.OSSConfigBean impl;
    ...
    */
    ...
    public ConfigServiceSoapBindingSkeleton() {
        this.impl = new ConfigService.ConfigServiceSoapBindingImpl();
    }

    public ConfigServiceSoapBindingSkeleton(ConfigService.OSSConfigBean impl) {
        this.impl = impl;
    }
